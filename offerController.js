...
function createOfferClicked() {
    ...
    if(validator.form()) {
        ...
        createOffer(offerObj, function (result) {
            ...
            //code for deleting previous image
...
function editOfferStoreClicked() {
    ...
    if(validator.form()) {
        ...
        console.log("offerObj.match_name: " + offerObj.match_name);
        console.log("offerObj.store_name: " + offerObj.store_name);
        console.log("offerObj.uuid: " + offerObj.uuid);
